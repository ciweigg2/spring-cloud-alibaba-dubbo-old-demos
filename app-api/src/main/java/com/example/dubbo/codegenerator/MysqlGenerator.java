...
public class MysqlGenerator extends GeneratorTest {
    ...
    public static void main(String[] args) {
        ...
        AutoGenerator mpg = new AutoGenerator().setGlobalConfig(
                // 全局配置
                new GlobalConfig()
                        .setOutputDir("./app-api/src/main/java")//输出目录
                ...
                new DataSourceConfig()
                        ...
                        .setUsername("root")
                        .setPassword("123456")
                        .setUrl("jdbc:mysql://115.220.10.37:3309/dubbo?useUnicode=true&allowPublicKeyRetrieval=true&useSSL=false&characterEncoding=utf8")
        ).setStrategy(
                // 策略配置
                new StrategyConfig()
                ...
                new PackageConfig()
                        ...
                        .setParent("com.example.dubbo")// 自定义包路径
